...
- [x] `Tasks/0007-TASK.md` — **Phase 7**: Parity pass + release smoke test — full build green; npm pack (105MB) + install + spawn-helper; app LAUNCHES in real Electron without crash; Results/RESULT.md + PARITY.md + Retro/LESSONS.md written. Live visual 1:1 + dictation/⌘W round-trips PENDING operator acceptance (computer-use grant + Spark backend). npm publish deferred to sign-off.
