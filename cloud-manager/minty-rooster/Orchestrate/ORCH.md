...
- [x] `Tasks/0000-TASK.md` — **Phase 0**: hv_status, confirm `minty-rooster` across all 15 repos
...
- [x] `Tasks/0006-TASK.md` — **Phase 6**: build + deploy verify per `@cloud-manager-deploy` (api/web smoke tests, mcp dist built but NOT reloaded)
- [x] `Tasks/0007-TASK.md` — **Final phase**: write `Results/RESULT.md` + `Retro/LESSONS.md`, then `hv_ship`
