...
## Orchestration
`lucky-engineblock` (plan codename — names this scaffold folder; the git execution branch is
recorded below by Task 0000)
...
| `workflow-exec` | This workflow folder |
