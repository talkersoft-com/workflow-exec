...
## TC-004 — Series prerequisites merged
Pass: P1 inventory layers (`gvar`/`hvar`), P2 `vblk`, and P4 C-VAR typing on `vdef` are all
present on origin/main (entities + migrations exist in cloud-manager-api).
Fail: any prerequisite missing — workflow must stop at Task 0000.
