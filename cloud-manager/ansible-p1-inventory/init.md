...
- `../../../workflow-plans/cloud-manager/ansible-p1-inventory/PLAN.md` — entity tables, route
  shapes, event types, open-question defaults
- `../../../workflow-plans/master-plans/ANSIBLE-EPIC-CONTRACTS.md` — prefixes, conventions,
  C-INV contract
- `../../../workflow-plans/master-plans/ANSIBLE-EPIC.md` — epic §2, §5
...
- Existing playbook/run/blueprint flows must remain byte-identical — regression-check in the
  final phase.
- Build after every implementation task; migration applied to live DB before API deploy; deploy
  api + mcp BEFORE the final hv_ship.
