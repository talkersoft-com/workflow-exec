# Orchestration: cloud-manager/raging-numbat
...
- [ ] `Tasks/0000-TASK.md` — **Phase 0**: hv_status; confirm `raging-numbat` across all repos
...
```
hv_workflow_run  deck: "cloud-manager"  branch: "raging-numbat"
```
