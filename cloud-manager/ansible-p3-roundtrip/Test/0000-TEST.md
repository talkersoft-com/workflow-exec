...
## TC-004 — P2 prerequisite merged
Pass: `play`/`ptask` entities and the decomposer service exist in cloud-manager-api on the
new branch (P2 merged to main).
Fail: P2 artifacts absent.
