...
Open `../deck.md`.
Pass: the Branch field is filled in with the generated branch name (not "giddy-minnow" placeholder or "TBD").
Fail: Branch field still says giddy-minnow or is missing.
